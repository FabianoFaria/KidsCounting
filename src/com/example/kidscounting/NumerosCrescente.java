...
public class NumerosCrescente extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tituloTela.setText("Digite os numeros de 1 à 10"); //Setta o texto do titulo da tela...
	...
	//Inicia o processo de contagem...
		...
		private void alteraTextView(int i) {
    		...
    		linhaContagem.setText(tempString + "-10");
		}
		
		//Metodo para verificar a resposta do usuario..
		private void submitGuess(Button guessButton) {
			 ...
			 for(int i = 1; i < respostaUser.size(); i++){
			    	...
			    	if(respostaUser.get(i).contains(String.valueOf(i))){ //está digitando o numero na sequencia correta...
